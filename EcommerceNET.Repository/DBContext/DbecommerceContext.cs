...
namespace EcommerceNET.Repository.DBContext;
...
public partial class DbecommerceContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__A3C02A105B186DF0");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__AAA5CEC29B63250C");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__098892108431F5E9");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF9761D6017E");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__BC1240BDDB5FF1F9");
